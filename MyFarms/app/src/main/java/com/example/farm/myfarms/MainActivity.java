...
import com.example.farm.myfarms.Adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(TodayWeatherFragment.getInstance(), "dzis");
        viewPager.setAdapter(adapter);
        fragmentManager = getSupportFragmentManager();
        fragmentTransaction = fragmentManager.beginTransaction();
        todayWeatherFragment = new TodayWeatherFragment();
        fragmentTransaction.add(R.id.fragmentToday, todayWeatherFragment, "dzis");
    }
